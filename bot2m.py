...
admin_user="HIKR7"
bot_token="6196647198:AAHQFa1vIXEfHgx8pIt_3h0Z0mwwifYChng"
...
bot = telebot.TeleBot(token=bot_token, num_threads=100)
...
def search_name_handler(message, city):
	...
	# التحقق من وجود علامة في نص الرسالة
	if any(char in name for char in sql_special_chars):
		bot.send_message(message.chat.id, 'سرسح منا')
		return
